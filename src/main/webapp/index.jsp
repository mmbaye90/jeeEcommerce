					...
					<ul>
						...
						<li data-transition="fade" data-slotamount="2"
							...
							<div class="tp-caption lft skewtoleftshort rs-parallaxlevel-9"
								...
								includes<br> all you need for a fashion and accessories
								store
							</div>
							<div class="tp-caption lft skewtoleftshort rs-parallaxlevel-9"
				...
				<div class="row">
					...
					<ul class="filter" data-option-key="filter">
						...
						<c:forEach var="item" items="${categories }">
							<li><a href="#" data-option-value=".${item.id}">${item.titre}</a></li>
						</c:forEach>
					...
					<div id="isotope" class="isotope">
						...
						<c:forEach var="prdct" items="${produits }">
							<div class="isotope-item ${ prdct.categorie_id}">
								<div class="product-item">
									...
									<div class="product-info">
										<h4 class="product-title">
											<a href="./single-product.html">${prdct.titre}</a>
										</h4>
										<strong class="product-price">${prdct.prix}<strong>E</strong></strong>
									</div>
								</div>
							</div>
						</c:forEach>
						...
						<!-- <div class="isotope-item clothing">
                            <div class="product-item">
                                ...
                                <div class="product-info">
                                    <h4 class="product-title"><a href="./single-product.html">Product fashion</a></h4>
                                    <span class="product-price"><small class="cutprice">$200.00</small> $99.00 <em>- Pre
                                            order</em></span>
                                    <div class="item-colors">
                                        <a href="#" class="black"></a>
